...
| 週次 | 主題 | 時數 | 內容 |
|:---:|------|:---:|------|
| 4 (2026/3/18)| Invited Talk: 徐任弘 (Jack Hsu) AWS Sr. Partner Solutions Architect, 莊昆霖 (Denny Jhuang) idanbean艾即思科技 Solutions Architect | 3h | AWS EC2 / ECS / Lambda、IAM / S3 / RDS、Kiro 環境、成本估算與 auto scaling、CDN / Cache |
...
| 11 (2026/5/6) | Invited Talk (Apache Taipei Funder, 「源來適你」Kafka Team) 資料庫系統與向量資料庫 | 3h | Embedding / HNSW / Retrieval、RAG pipeline（chunking → index → rerank）、Retrieval microservice |
---
